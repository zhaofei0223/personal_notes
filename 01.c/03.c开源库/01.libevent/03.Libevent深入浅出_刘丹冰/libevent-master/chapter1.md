...
> 1.4系列比较古老，但是源码简单，适合源码的学习<br>
2.0系列比较新，建议直接使用2.0

需要注意的是，1.4系列和2.0系列两个版本的接口并不兼容，就是2.0将一些接口的原型发生了改变，所以将1.4升级到2.0需要重新编码。
...
在官网上找到`libevent-2.1.12-stable.tar.gz`下载地址。
...
> 注意<br>
如果在libevent安装目录make之后会生成一个.libs/， 里面如果没有libevent_openssl.so说明系统没有安装openssl库。<br>
