...
![图15.1 类友元与类成员友元](./img/图15.1类友元与类成员友元.png)
...
```c++
Team::Coach forhire;    // create a Coash object outside the Team class
```
...
![图15.2 出现异常时的程序流程](./img/图15.2出现异常时的程序流程.png)
...
![图15.3 throw与return](./img/图15.3throw与return.png)
...
```c++
hmean(6, 06): invalid arguments: a = -b
Caught in means()
```
...
![图15.4 Grand类系列](./img/图15.4Grand类系列.png)
...
I hold the character V and the integer 31!
I am a superb class!!
I hold the superb value of 81!
I am a superb class!!
I hold the superb value of 7!
I am a grand class!
I am a grand class!
```
...
I am a magnificent class!!!
I hold the character Y and the integer 49!
