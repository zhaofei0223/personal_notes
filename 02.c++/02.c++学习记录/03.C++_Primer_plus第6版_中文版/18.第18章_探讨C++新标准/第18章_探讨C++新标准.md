...
const int & rb = b;   // b identifies datum at address &b
```
...
该程序的输出如下：
```c++
 tc value and address: 21.5, 0x7ffde8e71800
rd1 value and address: 7.07, 0x7ffde8e71808
rd2 value and address: 70.7, 0x7ffde8e71810
rd3 value and address: 21.5, 0x7ffde8e71818
```
...
Number of elements: 10 Data address: 0x55bdf192b2c0
copy const called; number of objects: 2
Number of elements: 10 Data address: 0x55bdf192b2e0
int, char constructor called; number of objects: 3
Number of elements: 20 Data address: 0x55bdf192b300
Entering operator+()
int constructor called; number of objects: 4
Number of elements: 30 Data address: 0x55bdf192b320
temp object:
Leaving operator+()
...
Entering operator+()
int constructor called; number of objects: 4
Number of elements: 30 Data address: 0x55af64308320
temp object:
Leaving operator+()
object one: xxxxxxxxxx
object two: xxxxxxxxxx
...
destructor called; objects left: 2
deleted object:
Number of elements: 20 Data address: 0x55af64308300
destructor called; objects left: 1
deleted object:
Number of elements: 10 Data address: 0x55af643082e0
destructor called; objects left: 0
deleted object:
Number of elements: 10 Data address: 0x55af643082c0
```
...
```c++
Sample size = 39
Count of numbers divisible by 3: 9
Count of numbers divisible by 13: 3

Sample size = 3900
Count of numbers divisible by 3: 1335
Count of numbers divisible by 13: 299

Sample size = 390000
Count of numbers divisible by 3: 130539
Count of numbers divisible by 13: 30032
```
...
```c++
Sample size = 390000
Count of numbers divisible by 3: 130021
...
```c++
Function pointer dub:
    use_f count = 1, &count = 0x55fb85a57154
2.42
Function pointer square:
    use_f count = 2, &count = 0x55fb85a57154
1.4641
Function object Fq:
    use_f count = 3, &count = 0x55fb85a57154
11.21
Function object Fq:
    use_f count = 4, &count = 0x55fb85a57154
11.21
Lambda expression 1:
    use_f count = 5, &count = 0x55fb85a57154
1.4641
Lambda expression 2:
    use_f count = 6, &count = 0x55fb85a57154
1.815
```
